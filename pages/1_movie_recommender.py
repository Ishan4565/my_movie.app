...
st.set_page_config(page_title="Ishan's AI Portfolio", page_icon="🚀")

st.title("🎬 Movie Matcher & AI Portfolio")
st.markdown("""
### Welcome to my Machine Learning Hub! 
This app showcases three distinct AI capabilities:
1. **Movie Recommendation** (Content-based filtering)
2. **Car Price Prediction** (Linear Regression)
3. **Health Diagnostics** (Classification)

**Use the sidebar on the left to switch between projects!**
""")
st.divider()
import streamlit as st
import pandas as pd
